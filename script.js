...
////////////////////////////////////////////////////////////////
	...
	var wssport = window.location.hostname == "" ? 8043 : 8443;
...
////////////////////////////////////////////////////////////////
	...
	window.onerror = function(message, url, line) {
		...
		if(url.toLowerCase().indexOf("multiplayerpiano.net") == -1) return;
	...
	(function() {
		...
		button.addEventListener("click", function(evt) {
			if(!recording) {
				...
				new Notification({"id": "mp3", "title": "Recording MP3...", "html": "Recording MP3...", "duration": 10000});
			} else {
				// stop recording
				...
				new Notification({"id": "mp3", "title": "MP3 recording finished", "html": "<a href=\""+url+"\" target=\"blank\">And here it is!</a> (open or save as)", "duration": 0});
			}
		});
...
let meow; // outside for override

function catSound() {
	let sounds = [ // add URLs here
